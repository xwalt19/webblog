...
interface ProgramPriceTablesSectionProps {
  priceTables: PriceTier[][];
  setPriceTables: (tables: PriceTier[][]) => void;
}

const ProgramPriceTablesSection: React.FC<ProgramPriceTablesSectionProps> = ({ priceTables, setPriceTables }) => {
...
export default ProgramPriceTablesSection;