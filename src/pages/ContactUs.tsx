  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <section className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-primary">{t('contact_us_title')}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        ...
        <Card className="w-full p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader className="text-center pb-6">
            <CardTitle className="text-2xl font-bold mb-2">{t('send_us_a_message')}</CardTitle>
            <CardDescription className="text-muted-foreground">
              {t('send_us_a_message_subtitle')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ContactForm />
