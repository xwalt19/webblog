...
const Archives: React.FC = () => {
  ...
  }, [allArchivePosts, selectedYear, selectedMonth, selectedTag, searchTerm]);
  ...
  return (
    <div className="container mx-auto py-10 px-4 bg-muted/40 rounded-lg shadow-inner">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-4 text-foreground capitalize">{t('archives')}</h1>
